...
public class APItems {
    ...
    public static void register() {
        ...
        ItemGroup group = ItemGroup.TAB_COMBAT;
        ...
        // ITEMS.register(ID_MAGMA_ARROW, () -> new ArrowItemCoFH(MagmaArrowEntity::new, new Item.Properties().tab(group).group(group)).setDisplayGroup(() -> ArchersParadox.itemGroup));
