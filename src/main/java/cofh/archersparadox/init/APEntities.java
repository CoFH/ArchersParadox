...
public class APEntities {
    ...
    public static void register() {
        ...
        ENTITIES.register(ID_DIAMOND_ARROW, () -> EntityType.Builder.<DiamondArrowEntity>of(DiamondArrowEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(ID_DIAMOND_ARROW));
        ...
        ENTITIES.register(ID_EXPLOSIVE_ARROW, () -> EntityType.Builder.<ExplosiveArrowEntity>of(ExplosiveArrowEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(ID_EXPLOSIVE_ARROW));
        ...
        ENTITIES.register(ID_PRISMARINE_ARROW, () -> EntityType.Builder.<PrismarineArrowEntity>of(PrismarineArrowEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(ID_PRISMARINE_ARROW));
        ENTITIES.register(ID_QUARTZ_ARROW, () -> EntityType.Builder.<QuartzArrowEntity>of(QuartzArrowEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(ID_QUARTZ_ARROW));
        ...
        ENTITIES.register(ID_SHULKER_ARROW, () -> EntityType.Builder.<ShulkerArrowEntity>of(ShulkerArrowEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(ID_SHULKER_ARROW));
        ENTITIES.register(ID_SLIME_ARROW, () -> EntityType.Builder.<SlimeArrowEntity>of(SlimeArrowEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(ID_SLIME_ARROW));
