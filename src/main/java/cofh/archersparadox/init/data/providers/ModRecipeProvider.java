...
public class ModRecipeProvider extends RecipeProviderCoFH {
    ...
    public ModRecipeProvider(PackOutput output) {
        ...
        super(output, ID_ARCHERS_PARADOX);
    }
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_QUARTZ_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_DIAMOND_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_PRISMARINE_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_SLIME_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_ENDER_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_TRAINING_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_CHALLENGE_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_PHANTASMAL_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_SHULKER_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_BLAZE_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_FROST_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_LIGHTNING_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_VERDANT_ARROW), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ITEMS.get(ID_SPORE_ARROW), 4)
