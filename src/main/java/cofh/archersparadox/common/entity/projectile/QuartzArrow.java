...
import static cofh.archersparadox.init.registries.ModEntities.QUARTZ_ARROW;
import static cofh.archersparadox.init.registries.ModItems.QUARTZ_ARROW_ITEM;
...
public class QuartzArrow extends AbstractArrow {
    ...
    public QuartzArrow(Level worldIn, LivingEntity shooter) {
        ...
        super(QUARTZ_ARROW.get(), shooter, worldIn, ItemStack.EMPTY);
        this.baseDamage = defaultDamage;
        setKnockback(0);
        setPierceLevel((byte) 0);
    }
    ...
    public QuartzArrow(Level worldIn, double x, double y, double z) {
        ...
        super(QUARTZ_ARROW.get(), x, y, z, worldIn, ItemStack.EMPTY);
        this.baseDamage = defaultDamage;
        setKnockback(0);
        setPierceLevel((byte) 0);
    }
